...
<head>
    ...
    <style>  
     body{               /* desing d page font avec background hotel */
         margin: 0;    
         padding: 0;
         font-family: 'Comic sans MS';
         background: url("/images/hotelR.jpg"); 
             ...
             <div class="col-sm-12 col-sm-4 register-top">  <!--class register-top--> 
                    ...
                    <form class="form-horizontal register-container tb-padding"method="POST" action="{{ route('register') }}"> <!--forme avc methode post --> 
                        ...
                        <div class="form-group "> 
                            <label for="name" class="col-sm-4 col-sm-2 col-form-label ">Nom de l'hotel:</label> <!-- le champ nom de l'hotel -->
                        ...
                        <div class="form-group">
                            <label for="email" class="col-md-4 col-sm-2 col-form-label ">E-mail de l'administartion :</label> <!-- le champ Email de l'administartion de l'hotel -->
                        ...
                        <div class="form-group"> <!-- le champ confirmer le mot de passe -->
                         ...
                         <div class="form-group "> <!--champs de la discription-->
                            <label for="discribtion" class="col-md-4 col-sm-2 col-form-label " id="discribtion">Discription de l'hotel </label>
                            <textarea class="form-control" rows="3"></textarea>

                         </div>
                        <div class="form-group"> <!-- le champ d'étoiles -->
                        <label for="étoiles" class="col-md-4 col-sm-2 col-form-label ">étoiles </label>
                        <div class="col-sm-6 col-sm-2">
                        ...
                        @if ($errors->has('étoiles')) <!-- generation des erreurs de saisi  -->
                                    <span class="help-block" >
                                        <strong>{{ $errors->first('étoiles') }}</strong>
                                    </span>
                         @endif
                        </div>
                        </div>
